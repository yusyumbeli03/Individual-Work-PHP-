<!-- Этот код на PHP реализует функциональность добавления, удаления и очистки товаров в корзине покупок, 
а также перенаправление на страницу оформления заказа. -->
<?php
