																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																			...
																			{
																			?>
																			<td> <button type="button"><b> Dispatch </b></button></td>
																		   <?php 
																			  }
																			   if($status=="in process")
																			 { ?>
																			<td> <button type="button"> <b> On The Way!</b> </button></td> 
																			<?php
																				}
																			if($status=="closed")
																				{
																			?>
																			<td> <button type="button" > <b>Delivered </b></button></td> 
																			<?php 
																			} 
																			?>
																			<?php
																			if($status=="rejected")
																				{
																			?>
																			<td> <button type="button" > <b> Cancelled </b></button></td> 
																			<?php 
																			} 
																			?>
																						<?php																									
